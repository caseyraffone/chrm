...
const styles = StyleSheet.create({
  ...
  scoreBig: { fontFamily: fonts.display, fontSize: 96, lineHeight: 100, letterSpacing: -4, includeFontPadding: false },
  scoreOutOf: { fontFamily: fonts.body, fontSize: 20, color: colors.textMuted, marginBottom: 6 },
  scorePlaceholder: { fontFamily: fonts.display, fontSize: 96, color: colors.textMuted, lineHeight: 100, includeFontPadding: false },
